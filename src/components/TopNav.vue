<template>
 <nav :class="navFix? 'fixed top-0 animate__fadeInDown':''" class=" duration-200 animate__animated  w-screen bg-white dark:bg-zinc-800 dark:text-white flex justify-between items-center px-4 md:px-10 py-3 shadow-md">
